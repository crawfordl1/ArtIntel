...
-No Robot Defined YetInitialize N amount of Particles and place them into List p
'''
...
p1 = []              #Initialize List to store each particle (created as its own Robot)
for i in range(N):
    x = robot()     #Create new Robot object
    p1.append(x)     #Put Robot in LIst p
