...
TOPIC: In a 2D world, apply Proportional Controller to Robot to CONVERGE to specified Trajectory
*Note: Robot no longer oscillates over Trajectory but converges to appropriate Goal Location (SMOOTHED PATH)
--A Steering Angle is pre-set to ensure that the Controller still makes the locations CONVERGE
'''
