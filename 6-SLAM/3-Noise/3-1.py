...
TOPIC: Graph SLAM implementation to find Robot & Landmarks Locations given specific Matrix Constraints & NOISE
'''
# ------------
# User Instructions
# 
...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    '''
    Set Dimension of of matrix within the Filter
    -Multiply by 2 to accommodate for X & Y coordinates
    '''
    dim = 2 * (N + num_landmarks)
    
    #Omega Matrix and relative Dimensions
    Omega = matrix()
    Omega.zero(dim, dim)
    
    #Strength Value relative to XI world size
    Omega.value[0][0] = 1.0     
    Omega.value[1][1] = 1.0  
    ...
    for k in range(len(data)):
        ...
        for i in range(len(measurement)):
            ...
            #Update the information matrix / vector based on the Measurement and relative Noise
            for b in range(2):  #Two iterations for X & Y implementation
                ...
                #Add measurement and its Noise to Vector Xi
                Xi.value[n+b][0] += -measurement[i][1+b] / measurement_noise
                Xi.value[m+b][0] += measurement[i][1+b] / measurement_noise
        
        #Iterate through all current Motions
        for b in range(4):
        ...
        for b in range(2):
            ...
            #Add Motion and its Noise to Vector Xi
