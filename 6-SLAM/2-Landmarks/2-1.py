...
TOPIC: Graph SLAM implementation to find Robot Locations given specific Matrix Constraints
'''
# -----------
# User Instructions
#
...
'''### DOIT() FUNCTION ###
    -Purpose: Determine Robot locations based on Constraints
    -Input: 
        -initial_pos - 
        -move1 - 
        -move2 - 
    -Output: 
        -New Omega & Xi values with accompanying Results detailing Best Estimates for all Robot locations
    '''
def doit(initial_pos, move1, move2):
    ...
    '''
    Now that Constraints #1 & #2 have been added, Calculate Best Estimates of Robot Locations
    '''
    mu = Omega.inverse() * Xi
    mu.show('Result: ')
